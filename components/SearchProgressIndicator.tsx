...
const STEPS: StepConfig[] = [
  ...
  },
  {
    id: 'resolving',
    icon: 'map.fill',
    title: 'Checking if location is mentioned',
    description: 'Looking for  location details',
    stages: ['resolving', 'filtering', 'people', 'keywords', 'searching', 'complete'],
  },
  {
    id: 'filtering',
    icon: 'line.3.horizontal.decrease.circle.fill',
    title: 'Filtering recalls by location',
    description: 'Finding recalls in the mentioned location/area',
    stages: ['filtering', 'people', 'keywords', 'searching', 'complete'],
  },
  {
    id: 'people',
    icon: 'person.2.fill',
    title: 'Checking if people are mentioned',
